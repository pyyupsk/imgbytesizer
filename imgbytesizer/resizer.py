...
def _try_combined_approach(
  ...
  for scale in scale_factors:
    ...
    if best_size_for_scale is not None:
      if best_size is None or abs(best_size_for_scale - target_size_bytes) < abs(best_size -
                                                                                 target_size_bytes):
    ...
    if (best_size_for_scale is not None and best_size_for_scale >= target_size_bytes * 0.95):
      break
